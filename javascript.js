...
function addList() {
  ...
  if (sdsd % 2 == 0) {
    aa =
      "<div class='it1 it1--1 fin1'><div class='osa'><input class='in1' type='checkbox' id=" +
      label_check +
      " name='scales' unchecked/></div><div><h1><label class='in' for=" +
      label_check +
      ">" +
      document.getElementById("addList_input1").value +
      "</label></h1></div></div><div class='it1 it1--2 '><span class='material-icons'>' edit' </span><span class='material-icons' class='in2'> 'clear' </span></div>";
  } else {
    aa =
      "<div class='it1 it1--3 fin1'><div class='osa'><input class='in1' type='checkbox' id=" +
      label_check +
      "name='scales' unchecked/></div><div><h1><label class='in' for=" +
      label_check +
      ">" +
      document.getElementById("addList_input1").value +
      "</label></h1></div></div><div class='it1 it1--4 '><span class='material-icons'>' edit' </span><span class='material-icons' class='in2'> 'clear' </span></div>";
  }
  ...
  document.getElementById("sec1").style.gridTemplateRows =
    "100px 100px 50% 70px";
}
